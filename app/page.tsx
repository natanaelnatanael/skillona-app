  ...
  return (
    <main style={{maxWidth:720,margin:"60px auto",padding:"0 16px"}}>
      ...
      <p style={{opacity:.8,marginBottom:18}}>
        Enter a topic or niche. You’ll get a demo link (mock) while we wire the AI services.
      </p>
      <textarea
        value={prompt}
        onChange={e=>setPrompt(e.target.value)}
        placeholder="e.g., Real estate tips for first-time buyers"
        style={{width:"100%",minHeight:120,background:"#12121a",border:"1px solid #2a2a3d",borderRadius:12,padding:12,color:"#fff"}}
      />
      <div style={{display:"flex",gap:12,marginTop:12,alignItems:"center"}}>
        <button onClick={submit} style={{padding:"12px 16px",borderRadius:12,border:"1px solid #6ee7b7",background:"#6ee7b7",fontWeight:700}}>
          Generate
        </button>
